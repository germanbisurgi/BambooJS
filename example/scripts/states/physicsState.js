...
physicsState.create = function () {
    ...
    // edges
    this.edge1 = this.physics.addEdge(10, 160, 190, 191, 'static');
    this.edge2 = this.physics.addEdge(190, 190, 390, 160, 'static');
    ...
    // Polygons
    this.polyBody = this.physics.addBody(100, 25, 'dynamic');
